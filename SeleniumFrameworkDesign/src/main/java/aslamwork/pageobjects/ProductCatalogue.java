...
public class ProductCatalogue extends AbstractComponents {
	...
	By toastMessage = By.cssSelector(".toast-bottom-right.toast-container");
	
	public List<WebElement> getProductList()
	{
		waitForElementForAppear(productsBy);
		return products;
	}
	...
	public void addProductToCart(String productName)
	{
		...
		waitForElementForAppear(toastMessage);
		waitForElementForInvisible(spinner);
	}
